document.addEventListener('DOMContentLoaded', function () {
  ...
  function showFormSuccess(form) {
    const successMessage = form.getAttribute('data-success-message') || 'Thank you! Your message has been sent.';
  ...
  function getErrorMessage(type, fieldName, extra) {
    ...
    const readableName = label ? label.textContent.trim().replace('*', '').trim() : fieldName;

    const messages = {
      required: readableName + ' is required.',
      email: 'Please enter a valid email address.',
      tel: 'Please enter a valid phone number.',
      minlength: readableName + ' must be at least ' + extra + ' characters.',
      maxlength: readableName + ' must be no more than ' + extra + ' characters.'
    };
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מוסכי השרון כ\"ס משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '116d6737-66bf-4545-8104-34c68e2c0d23',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '116d6737-66bf-4545-8104-34c68e2c0d23';
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to 09-7662888 placeholder which businessInfoUpdater can replace
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '116d6737-66bf-4545-8104-34c68e2c0d23';
